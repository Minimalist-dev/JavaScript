import { Canvas } from './export/canvas.js';
...
import('./export/main.js').then((Module) => {
let main = new Module.Main();
        main.constructor;
        main.consola();
})
...
// draw a square
        ...
        import('./export/square.js').then((Module) => {
...
// draw a circle
        ...
        import('./export/circle.js').then((Module) => {
...
// draw a triangle
        ...
        import('./export/triangle.js').then((Module) => {
